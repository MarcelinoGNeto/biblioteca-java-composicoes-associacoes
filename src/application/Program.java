...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		for (int i=1; i<n; i++) {
			...
			worker.addContract(contract); //associação: adicionando um contrato ao trabalhador
		}
		
		System.out.println();
		System.out.print("Enter month and year to calculate income (MM/YYYY): ");
		String monthAndYear = sc.next();
		int month = Integer.parseInt(monthAndYear.substring(0, 2)); //armazenar nesta variável os dois primeiros valores da data informada ('08'/2018)
